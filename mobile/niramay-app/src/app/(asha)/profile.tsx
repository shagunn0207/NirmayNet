  ...
  return (
    ...
    >
      ...
      <View style={styles.avatarCard}>
        ...
        <Text style={styles.roleSub}>Community Health Provider</Text>
      </View>
      ...
      <View style={styles.menuCard}>
        <TouchableOpacity
          ...
          onPress={() => Alert.alert('Settings', 'App version: 2.1.0 (Stable release)')}
        >
        ...
        <TouchableOpacity
          style={styles.menuItem}
          onPress={() => Alert.alert('Help & Support', 'Toll-free emergency health hotline: 108 / 104')}
        >
          <View style={styles.menuLeft}>
